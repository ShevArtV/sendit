export default class CustomInputNumber {
    constructor(element, config) {
        ...
        if(this.element.classList.contains('v_hidden')) return true;
    ...
    addMarkup() {
        const markup = {'wrapper': '', 'plus': '', 'field': '', 'minus': ''},
            rowmarkup = {
                wrapper: {
                    tagName: 'div',
                    classNames: ['input-number'],
                    type: ''
                },
                plus: {
                    tagName: 'button',
                    classNames: ['input-number__plus', 'input-number__btn'],
                    type: 'button'
                },
                field: {
                    tagName: 'input',
                    classNames: ['input-number__emulator'],
                    type: 'text',
                ...
                minus: {
                    tagName: 'button',
                    classNames: ['input-number__minus', 'input-number__btn'],
                    type: 'button'
                }
            };


        this.element.classList.add('v_hidden');
    ...
    addListeners() {
        const $this = this;
        $this.markup.plus.addEventListener('click', e => $this.numberUp());
        $this.markup.minus.addEventListener('click', e => $this.numberDown());
        $this.markup.field.addEventListener('change', e => $this.numberInput());
    }
