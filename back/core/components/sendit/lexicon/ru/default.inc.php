...
$_lang['setting_si_path_to_presets_desc'] = 'указывать путь к папке относительно корня сайта.';
...
$_lang['si_msg_file_open_err'] = '[[+filename]]: не удалось открыть файл для записи.';
$_lang['si_msg_file_size_err'] = '[[+filename]]: размер файла превышает максимально допустимый.';
$_lang['si_msg_file_extention_err'] = '[[+filename]]: файл имеет недопустимое расширение.';
$_lang['si_msg_files_count_err'] = '[[+filename]]: загружено максимально возможное количество файлов.';
